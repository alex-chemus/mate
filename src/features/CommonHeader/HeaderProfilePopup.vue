...
<template>
  <div class="profile-wrapper">
    <button
      class="bell-button" :class="[state.theme, { 'with-news': hasNews }]"
      @click="hasNews = !hasNews"
    >
      <svg width="30" height="30" viewBox="0 0 30 30">
        <use href="@/assets/tabler-sprite.svg#tabler-bell" />
      </svg>
    </button>

    <button class="popup-button" :class="state.theme" @click="isOpen = !isOpen">
