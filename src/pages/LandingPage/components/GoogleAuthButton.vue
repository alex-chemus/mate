  ...
  <auth-button :with-icon="true">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_24_804)">
        ...
        <path d="M16.0408 18.0126C14.9509 18.7163 13.5661 19.0909 12 19.0909C8.86651 19.0909 6.21914 17.0769 5.27701 14.2679L1.23749 17.335C3.19282 21.2936 7.26503 24 12 24C14.9329 24 17.7354 22.9574 19.8342 20.9996L16.0408 18.0126Z" fill="#34A853"/>
